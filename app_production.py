...
def privacy_policy():
    """Page de politique de confidentialité pour Léa Nutrition - Version entreprise complète"""
    return '''
    <!DOCTYPE html>
    <html lang="fr">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="legal-section">
                ...
                <p><strong>Contact DPO :</strong> support@lea-nutrition.com</p>
            </div>
            ...
            <div class="legal-section">
                ...
                <ul>
                    <li><strong>Nous contacter directement :</strong> support@lea-nutrition.com</li>
            ...
            <div class="contact-info">
                ...
                <h3>📧 Contact Email</h3>
                <ul>
                    <li><strong>Support général :</strong> support@lea-nutrition.com</li>
                    <li><strong>Protection des données :</strong> dpo@lea-nutrition.com</li>
                    <li><strong>Urgences sécurité :</strong> security@lea-nutrition.com</li>
                </ul>
